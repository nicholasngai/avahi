...
typedef struct AvahiServerConfig {
    ...
    AvahiStringList *reflect_routes;  /**< if enable_reflector is 1, will only reflect packets from certain input interfaces to output interfaces. This list should be of even length and contain alternating pairs of input, output */
